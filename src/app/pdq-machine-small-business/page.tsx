...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.posso.co.uk/pdq-machine-small-business',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'PDQ Machine for Small Business', item: 'https://www.posso.co.uk/pdq-machine-small-business' },
    ],
  },
];
