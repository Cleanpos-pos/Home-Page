...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/cafe-online-ordering-system',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Cafe Online Ordering System', item: 'https://posso.co.uk/cafe-online-ordering-system' },
    ],
  },
];
