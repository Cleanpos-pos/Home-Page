...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.posso.co.uk/online-ordering-platform-coffee-shops',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Online Ordering Platform for Coffee Shops', item: 'https://www.posso.co.uk/online-ordering-platform-coffee-shops' },
    ],
  },
];
