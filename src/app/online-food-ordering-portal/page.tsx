...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/online-food-ordering-portal',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Online Food Ordering Portal', item: 'https://posso.co.uk/online-food-ordering-portal' },
    ],
  },
];
