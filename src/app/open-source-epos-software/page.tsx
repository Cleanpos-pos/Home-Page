...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/open-source-epos-software',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Open Source ePOS Software', item: 'https://posso.co.uk/open-source-epos-software' },
    ],
  },
];
