...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/epos-software-for-takeaway-delivery',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Takeaway Delivery Software', item: 'https://posso.co.uk/epos-software-for-takeaway-delivery' },
    ],
  },
];
