...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/pizza-restaurant-software',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Restaurant Software', item: 'https://posso.co.uk/restaurant-epos' },
      { '@type': 'ListItem', position: 3, name: 'Pizza Restaurant Software', item: 'https://posso.co.uk/pizza-restaurant-software' },
    ],
  },
];
