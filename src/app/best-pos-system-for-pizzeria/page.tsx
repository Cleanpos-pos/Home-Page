...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/best-pos-system-for-pizzeria',
    type: 'article',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Best POS System for a Pizzeria', item: 'https://posso.co.uk/best-pos-system-for-pizzeria' },
    ],
  },
];
