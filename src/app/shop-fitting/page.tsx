            ...
            <main className="flex-1">
                <section className="relative w-full min-h-[70vh] flex items-center overflow-hidden pt-20">
                    ...
                    <div className="absolute inset-0 z-0">
                        <Image
                            ...
                            priority
                        />
                        <div className="absolute inset-0 bg-gradient-to-b from-background/40 via-background/80 to-slate-950" />
                    </div>
                ...
                <section className="container mx-auto px-4 py-20 md:px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {galleryImages.map((imageInfo, idx) => {
                            const imageUrl = 'src' in imageInfo ? imageInfo.src : PlaceHolderImages.find(p => p.id === imageInfo.id)?.imageUrl;
                            if (!imageUrl) return null;
                            return (
                                <div key={idx} className="relative aspect-square rounded-lg overflow-hidden glass-card p-1">
                                    <Image
                                        src={imageUrl}
                                        alt={imageInfo.alt}
                                        fill
