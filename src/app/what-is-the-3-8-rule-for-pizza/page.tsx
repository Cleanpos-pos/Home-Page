...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/what-is-the-3-8-rule-for-pizza',
    type: 'article',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'The 3/8 Rule for Pizza', item: 'https://posso.co.uk/what-is-the-3-8-rule-for-pizza' },
    ],
  },
];
