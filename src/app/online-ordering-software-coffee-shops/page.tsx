...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/online-ordering-software-coffee-shops',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Online Ordering Software for Coffee Shops', item: 'https://posso.co.uk/online-ordering-software-coffee-shops' },
    ],
  },
];
