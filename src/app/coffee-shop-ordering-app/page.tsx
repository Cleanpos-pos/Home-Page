...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.posso.co.uk/coffee-shop-ordering-app',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Coffee Shop Ordering App', item: 'https://www.posso.co.uk/coffee-shop-ordering-app' },
    ],
  },
];
