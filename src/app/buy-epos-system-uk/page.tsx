...
const benefits = [
  ...
  { title: 'No Lock-Ins', description: 'Buying outright means no lease penalties and no long-term contract lock-ins — the software runs from £35 + VAT a month, confirmed on your quote. You are never trapped: if you want to leave, your hardware is yours and your data exports freely.' },
