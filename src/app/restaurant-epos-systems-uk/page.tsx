...
const ukFeatures = [
  ...
  { icon: CreditCard, title: 'GBP Pricing, No Hidden Fees', description: 'POS from £499 + VAT. Kiosks from £699 + VAT. Prices in pounds sterling, software from £35 + VAT a month, and no per-transaction charges from Posso.' },
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 pt-20">
        ...
        <FAQSection title="UK Restaurant ePOS — Frequently Asked Questions" faqs={[
          ...
          { question: 'How much does a UK restaurant ePOS system cost?', answer: 'Posso restaurant ePOS starts from £499 + VAT for a complete terminal. Self-order kiosks from £699 + VAT. All prices are in GBP, with software from £35 + VAT a month. Finance options are available from £24.92/week.' },
        ]} />
