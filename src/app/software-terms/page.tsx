        ...
        <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
          <div className="mx-auto max-w-3xl prose prose-invert">
            ...
            <div className="space-y-6 text-slate-300 mt-8">
                ...
                <p><strong>3.11</strong> The user agrees to immediately notify the Company of any unauthorized use of their account, or any other breach of security at info@posso.co.uk</p>
                <p><strong>3.12</strong> Right to Erasure: Under Article 17 of GDPR, the User reserves the right to request an erasure of all their personal data from the Posso Ltd user account records, should the User wish to do so once this agreement is terminated. Any such Right to Erasure request must be communicated to Posso Ltd in writing info@posso.co.uk. In addition, as a Data Controller, it is the User’s responsibility to comply with any Right to Erasure requests received by the User from any of their customers regarding data stored on the Cloud Software. Posso Ltd, as a Data Processor, carries no responsibility with regards to any Right to Erasure requests received by the User from any of their customers.</p>
