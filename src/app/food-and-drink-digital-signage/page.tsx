...
const benefits = [
  { title: 'Increase Average Spend with Visual Menus', description: 'Customers spend more when they see appetising imagery alongside menu items. A photo of your signature burger with melting cheese drives more orders than text on a chalkboard. Digital signage with food photography puts the dish itself in front of the customer, rather than a line of text on a static menu.' },
