...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/web-based-ordering-system-coffee-shops',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Web Based Ordering System for Coffee Shops', item: 'https://posso.co.uk/web-based-ordering-system-coffee-shops' },
    ],
  },
];
