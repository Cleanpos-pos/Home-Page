...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/does-dominos-use-a-pos-system',
    type: 'article',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Does Domino\'s Use a POS System?', item: 'https://posso.co.uk/does-dominos-use-a-pos-system' },
    ],
  },
];
