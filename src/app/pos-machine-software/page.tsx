...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://posso.co.uk/pos-machine-software',
    type: 'website',
...
const pageSchema = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'POS Software', item: 'https://posso.co.uk/pos-software' },
      { '@type': 'ListItem', position: 3, name: 'POS Machine Software', item: 'https://posso.co.uk/pos-machine-software' },
    ],
  },
];
