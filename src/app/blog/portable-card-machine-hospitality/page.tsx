                    ...
                    <div className="container mx-auto px-4 max-w-4xl">
                        <div className="prose prose-invert prose-lg max-w-none">
                            ...
                            <p className="text-slate-300 text-xl leading-relaxed mb-10">
                                A modern portable card machine is no longer a luxury; it’s a necessity. At <Link href="https://posso.uk" className="text-primary font-bold hover:underline">Posso</Link>, we integrate with the UK’s leading payment providers—like <strong>Dojo, Teya, and Clover</strong>—to offer lightweight, robust card terminals that work right at the table.
                            </p>
