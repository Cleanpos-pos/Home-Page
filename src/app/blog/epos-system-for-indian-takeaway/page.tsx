                    ...
                    <div className="container mx-auto px-4 max-w-4xl">
                        <div className="prose prose-invert prose-lg max-w-none">
                            ...
                            <p className="text-slate-300">
                                Stop using generic retail systems for your curry house. Switch to a system designed for the heat of the takeaway kitchen. <Link href="https://posso.uk" className="text-orange-500 font-bold hover:underline">Posso&apos;s</Link> EPOS system for Indian takeaways is built for speed and accuracy.
                            </p>
                        ...
                        <div className="mt-24 p-12 text-center rounded-[3rem] bg-orange-600 relative overflow-hidden">
                            ...
                            <div className="flex flex-wrap justify-center gap-4">
                                ...
                                <Button size="lg" variant="outline" className="rounded-full px-10 h-14 bg-transparent border-white text-white hover:bg-white/10" asChild>
                                    <Link href="https://posso.uk">Visit POSSO.UK <ArrowRight className="ml-2 w-5 h-5" /></Link>
                                </Button>
                            </div>
                        </div>
                    </div>
