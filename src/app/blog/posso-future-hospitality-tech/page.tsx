                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div className="space-y-8">
                                ...
                                <p className="text-xl text-slate-400 leading-relaxed">
                                    The hospitality industry is evolving, and <Link href="https://posso.uk" className="text-primary font-bold hover:underline">Posso</Link> is leading the charge. We aren&apos;t just another software company; we are a dedicated tech partner for the modern UK food business.
                                </p>
                                <p className="text-xl text-slate-400 leading-relaxed">
                ...
                <section className="py-40 bg-gradient-to-t from-primary/20 to-transparent">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <Button size="lg" className="rounded-full h-16 px-12 text-xl bg-primary hover:bg-primary/90 text-white" asChild>
                            <Link href="https://posso.uk">Start Your Journey at Posso.uk</Link>
                        </Button>
                    </div>
                </section>
            </main>
