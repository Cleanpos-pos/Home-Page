      ...
      <main className="flex-1 pt-20">
        ...
        <section className="py-16 bg-slate-900/30">
          <div className="container mx-auto px-4 md:px-6 max-w-4xl">
            ...
            <div className="space-y-5 text-lg text-slate-300 leading-relaxed">
              <p>A simple till at the hatch is <strong className="text-white">£499 + VAT</strong> — touchscreen, printer, menu build and training. The setup most trailers want, though, is the full weatherproof <strong className="text-white">outdoor kiosk system — the self-order kiosk with a kitchen display, POS and printer built in — from £2,500 + VAT</strong>. Software is <strong className="text-white">£35 + VAT a month</strong>, finance is available from £24.92 a week, and card processing through Posso Pay is <strong className="text-white">from 1% + 10p</strong>, quoted on your turnover and the same rate in store and online.</p>
