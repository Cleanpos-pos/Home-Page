...
export const seoPages: SeoPageData[] = [
  {
    ...
    ctaText: "Get a free demo of Posso's dark kitchen ePOS system. Multi-brand, multi-platform, low commission on direct orders.",
  ...
  },
  {
    ...
    subtitle: "Low-commission online ordering with full ePOS integration. A smarter alternative to ePOS Now's ordering add-on.",
    category: "epos",
  ...
  },
  {
    ...
    subtitle: "Turn your Facebook page into a direct ordering channel. Orders go straight to your kitchen — low commission.",
    category: "ordering",
    targetKeyword: "Facebook food ordering system",
    heroContent: "Your customers are already on Facebook. Why send them to a third-party app to order? Posso's Facebook food ordering system lets customers browse your menu and place orders without leaving Facebook — with orders flowing directly into your ePOS and kitchen. Low commission, zero friction.",
    sections: [
...
function generateAutoPage(slug: string): SeoPageData {
  ...
  return {
    ...
    features: [
      ...
      { title: "Low Commission Rates Ordering", desc: "Accept online orders through your own branded website. Keep significantly more of your revenue." },
