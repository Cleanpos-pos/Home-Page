...
const hospitalityLinks = [
  ...
  { href: '/self-order-kiosk-cost', label: 'Self-Order Kiosk Cost' },
  { href: '/kitchen-display-system', label: 'Kitchen Display System' },
  { href: '/kitchen-display-system-cost', label: 'Kitchen Display Cost' },
  { href: '/epos-system-for-takeaway', label: 'EPOS for Takeaway' },
