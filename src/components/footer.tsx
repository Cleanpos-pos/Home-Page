            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                    ...
                    <nav aria-label="Hospitality solutions">
                        ...
                        <ul className="space-y-2 text-sm text-slate-400">
                            ...
                            <li><Link href="/ai-food-image-generator" className="hover:text-primary transition-colors">Free AI Food Image Generator</Link></li>
                ...
                <div className="mt-8 pt-8 border-t border-slate-800 flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="https://www.linkedin.com/in/paul-robinson-b158bb293" target="_blank" rel="noopener noreferrer" aria-label="Connect with Paul Robinson on LinkedIn">
