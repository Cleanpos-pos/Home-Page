...
import { CalendarDays, ArrowRight, Zap, TrendingUp } from 'lucide-react';
import Image from 'next/image';
import Link from 'next/link';

export function TableMaestroShowcase() {
    return (
        <section id="tablemaestro" className="w-full py-24 bg-slate-950 relative overflow-hidden" aria-label="TableMaestro online table booking system">
            {/* Background elements */}
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="flex flex-col gap-6 text-center lg:text-left items-center lg:items-start">
                        ...
                        <p className="text-xl font-medium text-blue-400/90 italic">
                            Online Table Booking &amp; Restaurant Promotion Engine
                        </p>
                        <p className="max-w-[600px] text-lg text-slate-400 leading-relaxed">
                            Transform how you manage reservations with TableMaestro. Accept online bookings 24/7, reduce no-shows with automated SMS reminders, and drive repeat visits with built-in promotional campaigns &mdash; all integrated with your Posso ePOS system.
                        </p>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 w-full max-w-lg mt-4">
                            <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                                ...
                                <div>
                                    <h3 className="font-bold text-slate-50">Smart Table Booking</h3>
                                    <p className="text-sm text-slate-400">Real-time table availability, instant confirmations, and automated SMS reminders.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                                <TrendingUp className="w-6 h-6 text-indigo-400" />
                                <div>
                                    <h3 className="font-bold text-slate-50">Promotion Engine</h3>
                                    <p className="text-sm text-slate-400">Automated discount codes, loyalty rewards, and targeted marketing campaigns.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            <Button size="lg" variant="outline" className="border-white/10 hover:bg-white/5" asChild>
                                <Link href="/tablemaestro">Learn More About TableMaestro</Link>
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        <div className="relative z-10 rounded-2xl overflow-hidden glass-card border-blue-500/20 shadow-2xl shadow-blue-900/20 transform hover:scale-[1.02] transition-transform duration-500">
                            <Image
                                ...
                                alt="TableMaestro restaurant table booking and promotion engine dashboard showing reservation management"
                                width={800}
                                height={600}
                        ...
                        <div className="absolute -bottom-10 -left-10 md:-left-20 z-20 w-[180px] md:w-[240px] rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-900/80 shadow-black/50 transform -rotate-12 hover:rotate-0 transition-transform duration-500">
                            <Image
                                ...
                                alt="TableMaestro mobile booking interface for restaurant table reservations"
                                width={300}
                                height={600}
